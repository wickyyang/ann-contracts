...
import "github.com/OpenZeppelin/openzeppelin-contracts/contracts/drafts/Counters.sol";
import "github.com/OpenZeppelin/openzeppelin-contracts/contracts/introspection/ERC165.sol";

/**
 * @title NFT 
 * @dev Non-Fungible Token Sample Contract
 */
contract NFT is ERC165, IERC721 {
    ...
    mapping(uint256 => uint256[]) private ownedTokens;
    ...
    /**
     * @dev Guarantees msg.sender is admin
     */
    modifier onlyAdmin {
     ...
     */
    function burn(address owner, uint256 tokenId) public onlyAdmin {
